...
import {createGame, createRoom, findUserInRoom, getAvailibleRooms} from "./rooms.js";

const WS_PORT = 3000

export const wsServer = new WebSocketServer({port: WS_PORT}, () => showMessage(`Start WS server on the ${WS_PORT} port!`, 'blue'));
